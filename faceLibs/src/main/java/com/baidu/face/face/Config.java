...
public class Config {
    ...
    public static String apiKey = "GZA8eIZ2XfUukiOPL5OyPL4O";
    public static String secretKey = "FOea6Q7ex9yOxFTnppTT5LOqXUq0yiEv";
    public static String licenseID = "mjxx-android-test-face-android";
