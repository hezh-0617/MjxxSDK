        ...
        switch (name) {
            ...
            case SpeechConstant.CALLBACK_EVENT_ASR_FINISH: {
                ...
                if (recogResult.hasError()) {
                    ...
                    LogUtil.e(TAG, "asr error:" + params);
            ...
            case SpeechConstant.CALLBACK_EVENT_ASR_LONG_SPEECH:  // 长语音
            ...
            case SpeechConstant.CALLBACK_EVENT_ASR_AUDIO:
                if (data.length != length) {
                    LogUtil.e(TAG, "internal error: asr.audio callback data length is not equal to length param");
                }
