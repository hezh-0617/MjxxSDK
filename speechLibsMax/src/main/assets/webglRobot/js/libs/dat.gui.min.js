...
!(function (e, t) {
    ...
    return (function (e) {
        ...
        var s = n(12),
            ...
            f = (function (e) {
                function t(n, o, a, s, u) {
                    ...
                    function f(e) {
                        e.preventDefault(); var t = h.__background.getBoundingClientRect();
        ...
        var u = n(7),
            ...
            v = (function (e) {
                function t(n, o) {
                    ...
                    return g.default.extend(v.__selector.style, {width: '122px', height: '102px', padding: '3px', backgroundColor: '#222', boxShadow: '0px 1px 3px rgba(0,0,0,0.3)'}), g.default.extend(v.__field_knob.style, {
                            position: 'absolute',
                            width: '12px',
                            height: '12px',
                            ...
                            borderRadius: '12px',
                            zIndex: 1
                        }), g.default.extend(v.__hue_knob.style, {position: 'absolute', width: '15px', height: '2px', borderRight: '4px solid #fff', zIndex: 1}), g.default.extend(v.__saturation_field.style, {
                            width: '100px',
                            height: '100px',
                            ...
                            cursor: 'pointer'
                        }), g.default.extend(w.style, {width: '100%', height: '100%', background: 'none'}), l(w, 'top', 'rgba(0,0,0,0)', '#000'), g.default.extend(v.__hue_field.style, {
                            width: '15px',
                            height: '100px',
                            border: '1px solid #555',
                            cursor: 'ns-resize',
            ...
            if (n.__li = t, n.__gui = e, U.default.extend(n, {
                    options: function (t) {
                        if (arguments.length > 1) {
                            ...
                            return n.remove(), s(e, n.object, n.property, {before: o, factoryArgs: [U.default.toArray(arguments)]});
                        }
        ...
        function s(e, t, n, o) {
            ...
            d.appendChild(u), d.appendChild(r.domElement); var c = i(e, d, o.before);
        ...
        var r = n(9),
            ...
            u = (function () {
                function e() {
                    ...
                    }), document.body.appendChild(this.backgroundElement), document.body.appendChild(this.domElement); var t = this;
