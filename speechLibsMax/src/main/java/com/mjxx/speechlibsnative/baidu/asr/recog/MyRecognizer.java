package com.mjxx.speechlibsnative.baidu.asr.recog;
...
//            throw new RuntimeException("还未调用release()，请勿新建一个新类");
    ...
    public void loadOfflineEngine(Map<String, Object> params) {
        ...
        LogUtil.i(TAG + ".Debug", "离线命令词初始化参数（反馈请带上此行日志）:" + json);
...
//            throw new RuntimeException("release() was called");
        ...
        // SDK集成步骤 拼接识别参数
        try {
            //java.io.FileNotFoundException: /data/user/0/com.mjxx.speech/files/log_switch.txt (No such file or directory)
            String json = new JSONObject(params).toString();
            LogUtil.i(TAG + ".Debug", "识别参数（反馈请带上此行日志）" + json);
